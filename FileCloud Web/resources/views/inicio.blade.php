    ...
    <tbody>
      @if(isset($documentos))
        <tr>
          ...
          <td><a href="{{$documentos['url1']}}" target="_blank">Descargar</a></td>
          @else
          <td>No disponible</td>
        ...
        <tr>
          ...
          <td><a href="{{$documentos['url2']}}" target="_blank">Descargar</a></td>
          @else
          <td>No disponible</td>
          <td>Descarga no disponible</td>
          @endif
        ...
        <tr>
          ...
          <td><a href="{{$documentos['url3']}}" target="_blank">Descargar</a></td>
          @else
          <td>No disponible</td>
          <td>Descarga no disponible</td>
          @endif
        ...
        <tr>
          ...
          <td><a href="{{$documentos['url4']}}" target="_blank">Descargar</a></td>
          @else
          <td>No disponible</td>
          <td>Descarga no disponible</td>
          @endif
            ...
            {{ csrf_field() }}
              ...
              <div class="row">
                ...
                <div class="col-md-3 mb-4">
                  ...
                  <input type="password" minlength="8" class="form-control shadow-sm p-3 mb-2 bg-white rounded" id="password" name="password" placeholder="Tu contraseña" required>
                </div>
                <div class="col-md-3 mb-4">
                  <label for="address">Número telefónico</label>
                  <input type="tel" class="form-control shadow-sm p-3 mb-2 bg-white rounded" name="address" maxlength="10" id="address" placeholder="1234567890" required>
                </div>
              </div>
